...
const CardDetails = () => {
    const notify = () => toast("Donate successfully");
        ...
        <div className="container mx-auto px-5 my-10">
            <div className="hero h-[70vh] rounded-xl flex flex-col-reverse items-end" style={{ backgroundImage: `url(${card.image})` }}>
                <div className="hero-overlay bg-black bg-opacity-50 h-24 lg:h-36 rounded-b-xl">
                    <Link>
                        <button onClick={notify} style={{ backgroundColor: '#FF444A' }} className="text-white p-3 rounded-lg m-5 px-7 lg:m-12 text-xl">Donate ${card.price}</button>
                    </Link>
                </div>
            </div>
